...
class PublicPageContent {
    ...
    get inputTitle() { return $('.review_create-input') }
    get inputContent() { return $('.content-text') }
    get btnSave() { return $('actions_bar-button actions_bar-button--publish post_create-actions-publish') }
    get draftBtn() { return $('button.actions_bar-button.actions_bar-button--draft') }
    get errorPopUp() { return $('.popup_message-block .popup_message-text')}

    get url() { return 'https://thinkmobiles.com/leave-review/'; }
    open () {
        return browser.url('https://thinkmobiles.com/leave-review/')
    }
...
module.exports = new PublicPageContent();